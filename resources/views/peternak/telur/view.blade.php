    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @endif
                <div class="p-6">
                    <a class="p-3 bg-lime-400 rounded" href="{{ route('peternak.telur-create') }}">Tambah Data</a>
                    <table class="table-auto border-separate border border-slate-300 w-full mt-4">
                        <thead>
                            <tr class="bg-slate-200">
                                ...
                                <th class="p-1 text-sm font-semibold tracking-wide">Telur didalam pembatas</th>
                                <th class="p-1 text-sm font-semibold tracking-wide">Total Telur</th>
                        ...
                        <tbody>
                            @foreach($egg as $telur)
                                <tr>
                                    ...
                                    <td class="p-2 text-center">{{ $telur->telurPembatas }}</td>
                                    <td class="p-2 text-center">{{ $telur->totalTelur }}</td>
