<div class="flex h-screen overflow-hidden">
    ...
    <div class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-slate-800 p-4 transition-all duration-200 ease-in-out -translate-x-64">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                        <a href="{{ route('admin.dashboard') }}" class="block text-slate-200 truncate transition duration-150 hover:text-white">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                        <a href="{{ route('admin.peternak') }}" class="block text-slate-200 truncate transition duration-150 hover:text-white">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center"><span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Data Akun</span></div> 
                            </div>
                        </a>
                    </li>
                    {{-- <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('admin.peternak')">
                                    {{ __('Akun Peternak') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('admin.peternak')">
                                    {{ __('Akun Pengolah') }}
