            ...
            <div>
                ...
                <ul class="mt-3">
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                        <a href="{{ route('pengolah.dashboard') }}" class="block text-slate-200 truncate transition duration-150 hover:text-white">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 false">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('pengolah.bahanbaku')">
                                    {{ __('Data Bahan Baku') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('pengolah.telurasin')">
                                    {{ __('Data Telur Asin') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('pengolah.penjualan')">
                                    {{ __('Data Penjualan') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
